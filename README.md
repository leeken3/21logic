...
### AI explanations
- Ollama: A free local AI engine used to generate recommendation explanations
- Default model: `llama3.1:latest`
- The first request can take longer while the model loads into memory
...
- If Ollama is running locally, the explanation text is generated by the AI engine

## Installation
- Ensure you have Java 17 and Maven installed on your machine.
- To enable AI explanations locally, install Ollama and pull a model such as `ollama pull llama3.1:latest`
